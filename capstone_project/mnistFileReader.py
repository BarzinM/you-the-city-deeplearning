...
def decompress(file_name):
    """
    Unzips a file with '.gz' extension.
    Example: decompress('somefile') -> decompresses somefile.gz

    Inputs: TODO
    """
    import gzip
    comp_file = gzip.open(file_name + '.gz', 'rb')
    with open(file_name, 'wb') as decomp_file:
        decomp_file.write(comp_file.read())
...
def maybeDownload(file_name):
    ...
    download('http://yann.lecun.com/exdb/mnist/' + compressed_file)
